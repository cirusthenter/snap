...
MotifType ParseMotifType(const TStr& motif, const bool& IsDirected)
{
    ...
    if (IsDirected) {
        if (motif_lc == "m1") {
            ...
            return M7;
        } else if (motif_lc == "triad") {
            return triad;
        } else if (motif_lc == "cycle") {
            return cycle;
        } else if (motif_lc == "ffloop") {
            return FFLoop;
        } else if (motif_lc == "unide") {
            return UniDE;
        } else if (motif_lc == "bide") {
            return BiDE;
        } else if (motif_lc == "de") {
            return DE;
        } else if (motif_lc == "edge") {
            return DE_any;
        } else {
        ...
        if (motif_lc == "uedge") {
            return UEdge;
        } else if (motif_lc == "clique3") {
            return clique3;
        } else if (motif_lc == "clique4") {
            return clique4;
        } else if (motif_lc == "clique5") {
            return clique5;
        } else if (motif_lc == "clique6") {
            return clique6;
        } else if (motif_lc == "clique7") {
            return clique7;
        } else if (motif_lc == "clique8") {
            return clique8;
        } else if (motif_lc == "clique9") {
            return clique9;
        } else {
